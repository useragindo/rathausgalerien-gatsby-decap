...
if (typeof document !== "undefined") {
   ...
   field (blocks, seo) has any content yet. Scoped per collection
   via the sidebar link href, so only the collections listed here
   (Pages/Funnels/Locations/Jobs/News/Lottery) get dividers.
   Intentionally not scoped to a decap-cms-app internal CSS class
		...
		body:has(a[href^="#/collections/pages"], a[href^="#/collections/funnels"], a[href^="#/collections/locations"], a[href^="#/collections/jobs"], a[href^="#/collections/news"], a[href^="#/collections/lottery"]) div:has(> label[for^="heading-field-"]),
		body:has(a[href^="#/collections/pages"], a[href^="#/collections/funnels"]) div:has(> label[for^="blocks-field-"]),
		body:has(a[href^="#/collections/pages"], a[href^="#/collections/funnels"], a[href^="#/collections/locations"], a[href^="#/collections/jobs"], a[href^="#/collections/news"], a[href^="#/collections/lottery"]) div:has(> label[for^="seo-field-"]),
		...
		body:has(a[href^="#/collections/jobs"], a[href^="#/collections/news"], a[href^="#/collections/categories"], a[href^="#/collections/lottery"]) div:has(> label[for^="text_color-field-"]),
		...
		body:has(a[href^="#/collections/pages"], a[href^="#/collections/funnels"], a[href^="#/collections/locations"], a[href^="#/collections/jobs"], a[href^="#/collections/news"], a[href^="#/collections/lottery"]) div:has(> label[for^="heading-field-"])::before,
		body:has(a[href^="#/collections/pages"], a[href^="#/collections/funnels"]) div:has(> label[for^="blocks-field-"])::before,
		body:has(a[href^="#/collections/pages"], a[href^="#/collections/funnels"], a[href^="#/collections/locations"], a[href^="#/collections/jobs"], a[href^="#/collections/news"], a[href^="#/collections/lottery"]) div:has(> label[for^="seo-field-"])::before,
		...
		body:has(a[href^="#/collections/jobs"], a[href^="#/collections/news"], a[href^="#/collections/categories"], a[href^="#/collections/lottery"]) div:has(> label[for^="text_color-field-"])::before,
